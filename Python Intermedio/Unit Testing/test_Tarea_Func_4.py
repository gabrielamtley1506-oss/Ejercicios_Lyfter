...
def test_upside_down_with_large_input_of_strings():
    ...
    #act
    upside_down(text_input)
    #assest
    assert ".margorp retfyL ot sknaht tnempoleved lufssecus a eb ot ydaer gnitteg m'I"
...
def test_upside_down_with_one_large_numerical_input():
    ...
    upside_down(text_input)
    #assest
    assert "7896541236547896578936521"