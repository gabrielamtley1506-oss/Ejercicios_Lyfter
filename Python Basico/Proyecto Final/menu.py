from actions import add_student, students_average, display_all_students, top_3_students, delete_student, failed_students
    ...
    while True:
        try:
            ...
            if option == 1:
                ...
                print(f"Student {new_student['Full Name']} added successfully!")
            elif option == 2:
