...
def save_csv(games_list, file_name="games.csv"):
    with open(file_name, "w", newline="", encoding="utf-8") as archive:
        ...
        writer = csv.DictWriter(archive, fieldnames=fields, delimiter="\t") # Agregue el delimiter para delimitarlos de la manera que yo quisisera, esta vez con tabulaciones como dice el ejercicio. 
